...
const comparisons = [
  {
    ...
    body: "CNR Solutions görünürlüğün ardından gelen müşteri, satış ve operasyon akışını sistemleştirir. Amaç sadece daha fazla görünmek değil; gelen talebi daha iyi yönetmek, takip etmek ve sonuca çevirmektir.",
  ...
  },
  {
    ...
    body: "CNR Solutions sistemi işletmenin gerçek iş akışına göre tasarlar. Ekip nasıl çalışıyor, müşteri nereden geliyor, süreç nerede kopuyor; önce bunu anlar, sonra sistemi buna göre kurar.",
  ...
  },
  {
    ...
    body: "CNR Solutions mevcut düzeni tamamen yıkmadan, ERP'nin etrafına görünürlük, takip ve operasyon katmanı kurar. Amaç sistemi büyütmek değil; işi daha net yönetilebilir hale getirmektir.",
