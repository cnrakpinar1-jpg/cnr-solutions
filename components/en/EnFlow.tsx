...
const steps = [
  {
    ...
    icon: "IN",
    label: "Data comes in",
    detail: "Spreadsheets, email, production records and energy data",
    badge: "Input",
  },
  {
    number: "02",
    ...
    detail: "Organized by product, customer and period",
    badge: "Clean",
  },
  {
    number: "03",
    icon: "!",
    label: "Gaps become visible",
    detail: "Missing, incorrect or pending fields",
    badge: "Flagged",
  },
  {
    number: "04",
    icon: "PK",
    label: "A data package is created",
    detail: "Ready for customer or regulatory requests",
    badge: "Ready",
  },
];
