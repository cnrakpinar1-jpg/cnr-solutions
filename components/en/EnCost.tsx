...
const risks = [
  {
    icon: "RQ",
    title: "Late customer response",
    text: "The request stays open while the team searches.",
  },
  {
    icon: "!",
    title: "Missing or wrong data",
    text: "The wrong version can reach the customer.",
  },
  {
    icon: "HR",
    title: "Lost internal time",
    text: "Search, correction and follow-up repeat.",
  },
  {
    icon: "TM",
    title: "Team confusion",
    text: "Ownership disappears between departments.",
  },
  {
    icon: "TR",
    title: "Trust loss",
    text: "Customers ask for the same data again.",
  },
  {
    icon: "RG",
    title: "Regulation readiness risk",
    text: "Data is pulled together at the last minute.",
  },
];
      ...
      <Reveal delay={180}>
        <div className="mt-6 rounded-[24px] border border-amber-300/16 bg-amber-300/[0.055] p-6 shadow-[0_20px_60px_rgba(2,6,23,0.34)] backdrop-blur-md">
          ...
          <p className="mt-2 text-xl font-semibold leading-8 text-white">
            Hours lost in file searching, corrections and follow-ups.
          </p>
        </div>
      </Reveal>
    </SectionShell>
